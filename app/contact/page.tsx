...
const page = () => {
    return (
        <section className="w-full h-[calc(100vh-4rem)] max-md:h-screen flex flex-col justify-around  bg-gradient-to-r from-[#4C5666] via-[#736C88] to-[#A681A0]">
            <h2 className="font-Belanosima text-center align-middle font-extrabold text-6xl text-transparent bg-clip-text bg-gradient-to-r from-white to-black ">Contact</h2>
